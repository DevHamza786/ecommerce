...
class HomeController extends Controller
{
    ...
    public function productIndex(){
        $products=Product::orderBy('id','DESC')->where('created_by',auth()->user()->id)->paginate(10);
    ...
    public function productReviewIndex(){
        $product = Product::where('created_by', auth()->user()->id)->pluck('id')->all();
        $reviews=ProductReview::whereIn('product_id', $product)->paginate(10);
