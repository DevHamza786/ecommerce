            ...
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="about-content">
                        <h3>Terms <span> Condition</span></h3>
                        <p>
                            Welcome to ABC!
                            Welcome to ABC!
                            These terms and conditions outline the rules and regulations for the use of ABC's Website,
                            located at https://www.abc.com/.
                            By accessing this website we assume you accept these terms and conditions. Do not continue to
                            use ABC if you do not agree to take all of the terms and conditions stated on this page.
                        ...
                        <h5>Cookies </h5><br>
                        <P>
                            We employ the use of cookies. By accessing ABC, you agreed to use cookies in agreement with the
                        ...
                        <h6>License</h6>
                        <br>
                        Unless otherwise stated, ABC and/or its licensors own the intellectual property rights for all
                        material on ABC. All intellectual property rights are reserved. You may access this from ABC for
                        your own personal use subjected to restrictions set in these terms and conditions.
                        You must not:
                        Republish material from ABC
                        Sell, rent or sub-license material from ABC
                        Reproduce, duplicate or copy material from ABC
                        Redistribute content from ABC
                        ...
                        in certain areas of the website. ABC does not filter, edit, publish or review Comments prior to
                        their presence on the website. Comments do not reflect the views and opinions of ABC,its agents
                        and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                        opinions. To the extent permitted by applicable laws, ABC shall not be liable for the Comments or
                        for any liability, damages or expenses caused and/or suffered as a result of any use of and/or
                        posting of and/or appearance of the Comments on this website.
                        ABC reserves the right to monitor all Comments and to remove any Comments which can be considered
                        ...
                        You hereby grant ABC a non-exclusive license to use, reproduce, edit and authorize others to use,
                        ...
                        <p>
                            ...
                            hyperlink compensates the absence of ABC; and (d) the link is in the context of general resource
                            information.
                            ...
                            our website, you must inform us by sending an e-mail to ABC. Please include your name, your
                            ...
                            No use of ABC's logo or other artwork will be allowed for linking absent a trademark license
                            agreement.
