																...
																<form class="form" method="post" action="{{route('review.store',$product_detail->slug)}}">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-4 col-4">
																			<div class="form-group">
																				<label>Phone</label>
																				<input type="tel" name="phone" placeholder="Please enter your name" required/>
																			</div>
																		</div>
																		<div class="col-lg-12 col-12">
																			<div class="form-group">
																				<label>Write a review</label>
																				<textarea name="review" rows="6" placeholder="Please enter your review" required></textarea>
																			</div>
																		</div>
																		<div class="col-lg-12 col-12">
