  ...
  <div class="card-body">
    <form action="{{route('user.productreview.update',$review->id)}}" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" disabled class="form-control" value="{{$review->name}}">
      </div>
      <div class="form-group">
        <label for="review">Review</label>
      <textarea name="review" id="" cols="20" rows="10" class="form-control" disabled>{{$review->review}}</textarea>
      </div>
      <div class="form-group">
